...
#Region "Connection"
    ...
    Dim conStr = $"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={Directory.GetParent(workingDirectory).Parent.Parent.Parent.Parent.Parent.FullName}\Database\EnrollmentSystem.accdb"
